...
func (r *Reconciler) installHelmChart(ctx context.Context, cni *v1.IstioCNI) error {
	...
	_, err = r.ChartManager.UpgradeOrInstallChart(ctx, r.Config.ResourceFS, r.getChartPath(version), mergedHelmValues, cni.Spec.Namespace, cniReleaseName, &ownerReference)
	if err != nil {
