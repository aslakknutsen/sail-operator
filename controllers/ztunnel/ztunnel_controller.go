...
func (r *Reconciler) installHelmChart(ctx context.Context, ztunnel *v1.ZTunnel) error {
	...
	_, err = r.ChartManager.UpgradeOrInstallChart(ctx, r.Config.ResourceFS, r.getChartPath(version), finalHelmValues, ztunnel.Spec.Namespace, ztunnelChart, &ownerReference)
	if err != nil {
